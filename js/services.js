...
angular.module('world.services', ['ngResource']).
  ...
  function ($resource){
    return $resource('https://maps.googleapis.com/maps/api/place/nearbysearch/json'
      ...
      , {location: '', radius:500, types:'', key: 'AIzaSyDnACcjGRPA_KhojEjtgHAzWBY9WsIW_rI'}, {
       query: {method: 'GET', params:{location: '', radius:500, types:'', key: 'AIzaSyDnACcjGRPA_KhojEjtgHAzWBY9WsIW_rI'}, isArray:false}
    });
  }]) 
  ...
  function ($resource){
    return $resource('/createtopic', {}, {
      create: {method: 'POST', params:{feedback:{}},isArray:false},
      feed : {method: 'GET', params:{},isArray:false},
      comment : {method: 'POST', params:{comments:{}},isArray:false},
    });
  }])
  .factory('GotoInfo', ['$resource',function ($resource){
    return $resource('/adscountclick', {}, {
      post:{method: 'POST',param:{_id:{}},isArray:false}   
    });
  }])
  ...
  .factory('Adsstatus',['$resource',function ($resource){
    return $resource('/adsstatus', {},{
      query : {method : 'GET',param:{},isArray:false},
      post : {method :'POST',params:{set:{}},isArray:false}
    });
  }])
  .factory('Adscreation', ['$resource',
  function ($resource){
    return $resource('/adsmanage', {}, {
      post: {method:'POST', params:{cus_regis:{}}, isArray:false} 
    });
  }])
  .factory('PasswordChange', ['$resource',
  function ($resource){
    return $resource('/forget', {}, {
      post: {method:'POST', params:{reset:{}}, isArray:false},
      query: {method: 'GET', params:{reset:{}},isArray:false}     
    });
  }])
  .factory('Permission', ['$resource',
  function ($resource){
    return $resource('/permission', {}, {
      post: {method:'POST', params:{permis:{}}, isArray:false},
      query: {method: 'GET', params:{},isArray:true}     
    });
  }])
  ...
  function($resource){
    return $resource('/checklogin', {}, {
      query: {method:'GET', params:{username:[],password:[]}, isArray:false}
  ...
  function($resource){
    return $resource('/uploadprofilepic', {}, {
      upload: {method:'POST', param:{activecode:{}}, isArray:false}
    });
  }])
  ...
  function($resource){
    return $resource('/login_activeuser', {}, {
      query: {method:'GET', params:{}, isArray:false},
      active: {method:'POST', param:{activecode:{}}, isArray:false}
    });
  }])
  ...
  function($resource){
    return $resource('/createproperty', {}, {
       post: {method:'POST', params:{property:{}}, isArray:false},
      query: {method:'GET', params:{_id:[]}, isArray:false}
  ...
  function($resource){
    return $resource('/propertiesalone', {}, {
       post: {method:'POST', params:{prop:{}}, isArray:false},
      query: {method:'GET', params:{_id:[]}, isArray:false}
  ...
  function($resource){
    return $resource('/propertyInfo', {}, {
      query: {method:'GET', params:{}, isArray:false},
      kill: {method: 'DELETE', params:{}, isArray:false}
  ...
  function($resource){
    return $resource('/search', {}, {
      post: {method:'POST', params:{search:{}}, isArray:true},
      query: {method:'GET', params:{}, isArray:true}
    });
  }])
  ...
  function($resource){
    return $resource('/login_resendemail', {}, {
      query: {method:'GET',params:{reg:{}}, isArray:false},
      post: {method:'post',params:{upgrade:{}},isArray:false}
  ...
  function($resource){
    return $resource('/login', {}, {
      post: {method:'POST', params:{reg:{}}, isArray:false},
      query: {method:'GET',params:{}, isArray:false}
  ...
  function ($resource){
    return $resource('/customer', {customerId: ''}, {
      get: {method: 'GET', params:{customerId: ''}, isArray:false}     
    });
  }])
  .factory('CustomerProperty', ['$resource',
  function ($resource){
    return $resource('/customerproperties/:customerId', {customerId: ''}, {
  ...
  function ($resource){
    return $resource('/customerowner', {customerId: ''}, {
      get: {method: 'GET', params:{customerId: ''}, isArray:false}     
    });
  }])
  // ads sponsor
  ...
  function ($resource){
    return $resource('/favorite', {}, {
      get: {method: 'GET', params:{user_id: ''}, isArray:true},
      owerget:{method: 'GET', params:{owner_id: ''}, isArray:true},
      post: {method: 'POST', params:{}, isArray:false},
      kill: {method: 'DELETE', params:{}, isArray:false}
    });
  }])  
